...
<html lang="es">
	<head><base href="">
		...
		<meta property="og:site_name" content="SERVICIOS DE MANTENIMIENTO" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
                        ...
                        <!--a class="btn btn-flex btn-color-success fs-base p-0 ms-2 mb-2 collapsible rotate collapsed" >												
                            <span data-kt-toggle-text-target="true" style="font-size: 50px;">F</span>
                            <span class="color:white;" data-kt-toggle-text-target="true" style="font-size: 29px;color: #fff;">armacia</span>
                        </a-->
						<!--end::Logo-->
						<!--begin::Aside toggler-->
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">								
								...
								<div class="menu-item d-none">
									<a class="menu-link" href="{{route("home.dashboard")}}" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="{{route("service.start", ["opcion"=> "start-service"])}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Iniciar Servicio</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="{{route("service.history")}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Historial Servicio</span>
											</a>
										</div>
										<div class="menu-item"> 
											<a class="menu-link" href="{{route("service.start", ["opcion"=> "unfinished-service"] )}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Servicios no concluidos</span>
											</a>
										</div>
									</div>
								</div>
							...
							<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
								...
								<div class="d-flex align-items-stretch " id="kt_header_nav">
									...
									<div class="header-menu align-items-stretch d-none" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1 showing hover">
												<span class="menu-link py-3">
													<span class="menu-title">Dashboard ed</span>
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									<!--div class="d-flex align-items-center ms-1 ms-lg-3">
										<a href="#" class="btn btn-icon btn-color-gray-600 btn-active-color-primary" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu" style="">
											...
											<div class="menu-item px-3 my-0">
												<a href="#" class="menu-link px-3 py-2 menu-link-theme" data-kt-element="mode" data-kt-value="light">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3">
										<a class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-100 h-30px h-md-40px" href="javascript:void()">
											{{ session()->get("Nombre")  }}
										</a>
									</div>
									<!--div class="d-flex align-items-center ms-1 ms-lg-3">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<img src="{{asset('assets/media/logos/avatar.svg')}}" alt="user" class="b-radius-50"  />
										</div>
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="symbol symbol-50px me-5">
														<img alt="Logo" src="{{asset('assets/media/logos/avatar.svg')}}" />
													</div>
													<!--end::Avatar-->
													<!--begin::Username-->
													<div class="d-flex flex-column">
														<div class="fw-bolder d-flex align-items-center fs-5">{{ session()->get("Nombre")  }}
											...
											<div class="separator my-2"></div>
											<div class="menu-item px-5">
												@if (Route::has('sign-out'))
													<a href="{{ route('sign-out')}}" class="menu-link px-5">Cerrar sesión</a>
												@endif
											</div>
									...
									<div class="d-flex align-items-center d-lg-none ms-2 me-n3 d-none" title="Show header menu">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									@yield('contentHeaderLeft')
								</div>
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									@yield('contentHeaderRight')
								</div>
							</div>
						</div>
						<!--end::Toolbar-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">MR PERU</a>
							</div>
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="inline">
							...
							<div class="py-5">
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Max Smith edw</a>
													<div class="fw-bold text-muted">max@kt.com</div>
												</div>
												<!--end::Details-->
											</div>
								...
								<!--end::Results-->
								<!--begin::Empty-->
								<div data-kt-search-element="empty" id="id_edwin" class="text-center d-none">
									<!--begin::Message-->
        ...
        <script>var APP_URL_BK = "{{config('app.app_name_mr_peru')}}";</script>
        <script>var APP_ERROR_SERVER = "Ocurrió un problema, recargue la pagina por favor.";</script>
        <script>
            /*Toast.fire({
                icon: 'success',
                title: 'Es un mensaje de ventas'
            });
			*/
			$(document).ready(async function (){
				function SwallAt(){
					Swal.fire({
						text:"Sorry, looks like edwin ayala there are some errors detected, please try again.",
						icon:"error",
						buttonsStyling:!1,
