                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 form_validate">
                        <div class="d-flex justify-content-between ">
                            <div class="fv-row  w-100">
                                ...
                                <input type="text" placeholder="Correo y electronico" class="my-2 form-control form-control-sm fw-bold fs-4 d-block w-100 fs-4" id="add_email_contact" name="add_email_contact"  >
                            </div>
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 form_validate">
                        <div class="d-flex justify-content-between">
                            <div class="fv-row w-100">
                                ...
                                <input type="text" placeholder="Correo y electronico" class="my-2 form-control form-control-sm fw-bold fs-4 d-block w-100 fs-4" id="add_email_jefe_contact" name="add_email_jefe_contact"  >
                            </div>
                        </div>
                        <div class="text-end  my-2  " >
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-8">
        <div class="card-body py-3">
            <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_compresor">
                <!--begin::Nav-->
                        ...
                        <div class="w-100" id="kt_form_input_page_2" >
                            ...
                            <div class="row g-9 mb-8" >
                                ...
                                <div class="col-md-3 col-sm-4  fv-row">
                                    ...
                                    <input type="text" id="service_equipo_horometro" name="equipo_horometro" class="form-control form-control-bg fs-4 form-control-sm"  >
                                    <span class="fs-5 cls_empty text-danger " data-validator="notEmpty"></span>
                                </div>
                                <div class="col-12 fv-row">
                                    <label class="d-flex align-items-center fs-4 fw-semibold mb-2">
